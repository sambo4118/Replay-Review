...
class Command {
  ...
  endTime;
  constructor(params) {
    this.type = params?.type ?? exports.CommandType.None;
    this.parameter = params?.parameter ?? exports.ParameterType.None;
    this.easing = params?.easing ?? exports.EasingType.None;
...
class CommandLoop extends CommandTimelineGroup {
  type = exports.CompoundType.Loop;
  loopStartTime;
  loopCount;
...
class CommandTrigger extends CommandTimelineGroup {
  type = exports.CompoundType.Trigger;
  triggerName;
  triggerStartTime;
  triggerEndTime;
  groupNumber;
...
class StoryboardSprite {
  ...
  constructor(path, origin, anchor, position) {
    this.filePath = path ?? '';
    this.origin = origin ?? exports.Origins.TopLeft;
    this.anchor = anchor ?? exports.Anchor.TopLeft;
...
class StoryboardAnimation extends StoryboardSprite {
  ...
  constructor(path, origin, anchor, position, frameCount, frameDelay, loopType) {
    ...
    this.loopType = loopType ?? exports.LoopType.LoopForever;
  }
}
...
class Storyboard {
  ...
  getLayerByType(type) {
    return this.getLayerByName(exports.LayerType[type] ?? 'Background');
  }
  getLayerByName(name) {
...
class BeatmapGeneralSection {
  ...
  stackLeniency = 0.7;
  countdownOffset = 0;
  sampleSet = exports.SampleSet.Normal;
...
class DifficultyPoint extends ControlPoint {
  ...
  pointType = exports.ControlPointType.DifficultyPoint;
  generateTicks = true;
  isLegacy = false;
...
class EffectPoint extends ControlPoint {
  ...
  pointType = exports.ControlPointType.EffectPoint;
  kiai = false;
...
class SamplePoint extends ControlPoint {
  ...
  pointType = exports.ControlPointType.SamplePoint;
  sampleSet = exports.SampleSet[exports.SampleSet.Normal];
  customIndex = 0;
  volume = 100;
  isRedundant(existing) {
...
class TimingPoint extends ControlPoint {
  ...
  pointType = exports.ControlPointType.TimingPoint;
  ...
  timeSignature = exports.TimeSignature.SimpleQuadruple;
  get bpmUnlimited() {
...
class HitObject {
  ...
  nestedHitObjects = [];
  startTime = 0;
  hitType = exports.HitType.Normal;
  hitSound = exports.HitSound.Normal;
  samples = [];
...
class HitSample {
  sampleSet = exports.SampleSet[exports.SampleSet.None];
  hitSound = exports.HitSound[exports.HitSound.Normal];
  customIndex = 0;
  suffix = '';
  volume = 100;
  isLayered = false;
...
class SampleBank {
  filename = '';
  volume = 100;
  normalSet = exports.SampleSet.Normal;
  additionSet = exports.SampleSet.Normal;
  customIndex = 0;
  clone() {
...
class Autoplay {
  name = 'Autoplay';
  acronym = 'AT';
  bitwise = exports.ModBitwise.Autoplay;
  type = exports.ModType.Automation;
  multiplier = 1;
  isRanked = false;
  incompatibles = exports.ModBitwise.NoFail |
...
class Cinema {
  name = 'Cinema';
  acronym = 'CN';
  bitwise = exports.ModBitwise.Cinema;
  type = exports.ModType.Fun;
  multiplier = 1;
  isRanked = false;
  incompatibles = exports.ModBitwise.NoFail |
        exports.ModBitwise.SuddenDeath |
...
class DoubleTime {
  ...
  type = exports.ModType.DifficultyIncrease;
  multiplier = 1.12;
  isRanked = true;
  incompatibles = exports.ModBitwise.HalfTime | exports.ModBitwise.Nightcore;
...
class Easy {
  name = 'Easy';
  acronym = 'EZ';
  bitwise = exports.ModBitwise.Easy;
  type = exports.ModType.DifficultyReduction;
  multiplier = 0.5;
  isRanked = true;
  incompatibles = exports.ModBitwise.HardRock;
  applyToDifficulty(difficulty) {
...
class Flashlight {
  name = 'Flashlight';
  acronym = 'FL';
  bitwise = exports.ModBitwise.Flashlight;
  type = exports.ModType.DifficultyIncrease;
  multiplier = 1.12;
  isRanked = true;
  incompatibles = exports.ModBitwise.None;
}

class HalfTime {
  name = 'Half Time';
  acronym = 'HT';
  bitwise = exports.ModBitwise.HalfTime;
  type = exports.ModType.DifficultyReduction;
  multiplier = 0.3;
  isRanked = true;
  incompatibles = exports.ModBitwise.DoubleTime | exports.ModBitwise.Nightcore;
  applyToDifficulty(difficulty) {
...
class HardRock {
  name = 'Hard Rock';
  acronym = 'HR';
  bitwise = exports.ModBitwise.HardRock;
  type = exports.ModType.DifficultyIncrease;
  multiplier = 1.06;
  isRanked = true;
  incompatibles = exports.ModBitwise.Easy;
  applyToDifficulty(difficulty) {
...
class Hidden {
  name = 'Hidden';
  acronym = 'HD';
  bitwise = exports.ModBitwise.Hidden;
  type = exports.ModType.DifficultyIncrease;
  multiplier = 1.06;
  isRanked = true;
  incompatibles = exports.ModBitwise.None;
...
class Nightcore extends DoubleTime {
  name = 'Nightcore';
  acronym = 'NC';
  bitwise = exports.ModBitwise.Nightcore;
  incompatibles = exports.ModBitwise.HalfTime | exports.ModBitwise.DoubleTime;
}

class NoFail {
  name = 'No Fail';
  acronym = 'NF';
  bitwise = exports.ModBitwise.NoFail;
  type = exports.ModType.DifficultyReduction;
  multiplier = 0.5;
  isRanked = true;
  incompatibles = exports.ModBitwise.SuddenDeath |
        exports.ModBitwise.Perfect |
        exports.ModBitwise.Autoplay |
        exports.ModBitwise.Cinema |
        exports.ModBitwise.Relax |
...
class NoMod {
  name = 'No Mod';
  acronym = 'NM';
  bitwise = exports.ModBitwise.None;
  type = exports.ModType.System;
  multiplier = 1;
  isRanked = true;
  incompatibles = exports.ModBitwise.None;
}
...
class Perfect {
  name = 'Perfect';
  acronym = 'PF';
  bitwise = exports.ModBitwise.Perfect;
  type = exports.ModType.DifficultyIncrease;
  multiplier = 1;
  isRanked = true;
  incompatibles = exports.ModBitwise.NoFail |
...
class Relax {
  name = 'Relax';
  acronym = 'RX';
  bitwise = exports.ModBitwise.Relax;
  type = exports.ModType.Automation;
  multiplier = 1;
  isRanked = false;
  incompatibles = exports.ModBitwise.NoFail |
...
class LegacyReplayFrame extends ReplayFrame {
  ...
  constructor(startTime, interval, position, buttonState) {
    ...
    this.position = position ?? new Vector2(0, 0);
    this.buttonState = buttonState ?? exports.ReplayButtonState.None;
  }
  get mouseX() {
